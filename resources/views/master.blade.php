...
<body>
  ...
  <div class="d-flex align-items-center gap-3">
    <a class="d-flex align-items-center" href="#">
      <img src="{{ asset('assets/images/logos/Logo PT.png') }}" alt="Logo PT" style="max-width: 36px; height: auto;">
    </a>
    <span class="brand-name text-white fw-semibold fs-5 m-0">PRIMA RAMA JAYA</span>
  </div>
</div>
  ...
  <a href="./index.html" class="brand-text text-decoration-none fw-bold text-uppercase">
    PRIMA RAMA JAYA
  </a>
    ...
    <i class="ti ti-x fs-6"></i>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <!-- ---------------------------------- -->
            <li class="sidebar-item">
            <a class="sidebar-link justify-content-between" href="/review-karyawan">
                <div class="d-flex align-items-center gap-3">
                  <div class="round-16 d-flex align-items-center justify-content-center">
                    <i class="ti ti-circle"></i>
                  </div>
                  <span class="hide-menu">Review Karyawan</span>
                </div>
              </a>
            </li>
            <li class="sidebar-item">
            ...
            <li class="sidebar-item">
              ...
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                 <a class="sidebar-link justify-content-between" href="/kelola-karyawan">
                <div class="d-flex align-items-center gap-3">
                  <div class="round-16 d-flex align-items-center justify-content-center">
                    <i class="ti ti-circle"></i>
                  </div>
